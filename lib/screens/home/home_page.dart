...
import 'package:nexmusic/screens/home/cubit/home_cubit.dart';
  ...
  void _showSupportDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Support NexMusic'),
        content: const Text(
          'This app requires time and hard work to develop and maintain. '
          'If you enjoy using NexMusic, please consider supporting the developer.',
        ),
        actions: [
          TextButton(
          ...
          FilledButton(
            onPressed: () async {
              ...
              final uri = Uri.parse('https://arabiislam.odoo.com/');
