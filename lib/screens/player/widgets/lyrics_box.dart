...
import 'package:nexmusic/models/lyrics_model.dart'; // Import the new model
import 'package:nexmusic/services/lyrics.dart'; // Import the new service
      ...
      child: SingleChildScrollView(
        ...
        child: SelectableText(
          ...
          style: TextStyle(
            ...
            color: Colors.white,
            height: GetIt.I<SettingsManager>().lyricsLineSpacing,
            letterSpacing: 0.2,
          ),
        ),
      ),
...
class _SyncedLyricsWidgetState extends State<SyncedLyricsWidget>
  ...
  void _scrollToCurrentLyric(int index) {
    if (!GetIt.I<SettingsManager>().autoScrollLyrics) return;
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      return AnimatedDefaultTextStyle(
                        ...
                        style: TextStyle(
                          fontSize: isCurrent
                              ? GetIt.I<SettingsManager>().lyricsTextSize + 14
                              : GetIt.I<SettingsManager>().lyricsTextSize + 4,
                          fontWeight:
