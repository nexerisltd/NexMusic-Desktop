...
import 'package:nexmusic/screens/player/widgets/play_pause_buton.dart';
import 'package:nexmusic/utils/song_thumbnail.dart';
                  ...
                  children: [
                    ...
                    Positioned.fill(
                      child: Builder(builder: (context) {
                        final style = GetIt.I<SettingsManager>()
                        ...
                        if (style == 1) {
                          ...
                          // Liquid Glass: blurred album art + dark scrim
                          final artUri = currentSong?.artUri?.toString();
                          return Stack(
                            fit: StackFit.expand,
                            children: [
                              if (artUri != null)
                        ...
                        return AnimatedGradientBackground(colors: colors);
                      }),
                    ),
                                                            ...
                                                            child: ClipRRect(
                                                              borderRadius:
                                                                  BorderRadius
                                                                      .circular(
                                                                          GetIt.I<SettingsManager>().thumbnailCornerRadius),
                                                              child: GetIt.I<SettingsManager>().hidePlayerThumbnail
                                                                  ? Image.asset(
