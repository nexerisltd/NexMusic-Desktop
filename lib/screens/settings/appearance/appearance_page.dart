                ...
                return ListView(
                  ...
                  children: [
                    ...
                    SettingSliderTile(
                      ...
                      max: 40,
                      divisions: 26,
                      valueLabel: (v) => "${v.toInt()} sp",
                      onChanged: (value) {
                        context
                            .read<AppearanceCubit>()
                            .setLyricsTextSize(value);
                      },
                      isFirst: true,
                    ),
                    ...
                    SettingSliderTile(
                      ...
                      subtitle:
                          "Change the corner radius of the album cover thumbnail",
                      leading: const Icon(Icons.crop_square),
                      value: s.thumbnailCornerRadius,
                      min: 0,
                      max: 40,
                      divisions: 40,
                      valueLabel: (v) => "${v.toInt()}dp",
                      onChanged: (value) {
                        context
                            .read<AppearanceCubit>()
                            .setThumbnailCornerRadius(value);
                      },
                      isFirst: true,
                    ),
                    ...
                    SettingSwitchTile(
                      ...
                      subtitle: "Replace album artwork with app logo in player",
                      leading: const Icon(Icons.hide_image_outlined),
                      value: s.hidePlayerThumbnail,
                      onChanged: (value) {
                        context
                            .read<AppearanceCubit>()
                            .setHidePlayerThumbnail(value);
                      },
                      isLast: false,
                    ),
                    ...
                    SettingTile(
                      ...
                      trailing: AdaptiveDropdownButton<int>(
                        value: s.playerBackgroundStyle,
                        items: [
                          AdaptiveDropdownMenuItem(
                            value: 0,
                            child: const Text("Animated Gradient"),
                          ),
                          AdaptiveDropdownMenuItem(
                            value: 1,
