...
import 'package:nexmusic/services/update_service/models/update_info.dart';
import 'package:nexmusic/services/update_service/widgets/update_checking.dart';
import 'package:nexmusic/services/update_service/widgets/update_dialog.dart';
import 'package:http/http.dart' as http;
import 'package:package_info_plus/package_info_plus.dart';
import 'package:pub_semver/pub_semver.dart';

class UpdateService {
  static const String owner = 'nexerisltd';
  static const String repo = 'NexMusic-Desktop';
  ...
  static Future<UpdateInfo?> checkForUpdate() async {
    try {
      ...
      final Uri uri = Uri.parse(
        'https://raw.githubusercontent.com/nexerisltd/NexMusic-Desktop/main/desktop_update.json',
      );
      ...
      if (remoteVersion != currentVersion) {
        return UpdateInfo(
          ...
          body: 'A new version of NexMusic is available. Please update to continue.',
          publishedAt: '',
          downloadUrl: 'https://github.com/nexerisltd/NexMusic-Desktop/releases/latest',
        );
      }
